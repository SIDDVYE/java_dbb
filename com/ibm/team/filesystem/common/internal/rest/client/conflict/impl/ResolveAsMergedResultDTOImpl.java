...
public class ResolveAsMergedResultDTOImpl extends EObjectImpl implements ResolveAsMergedResultDTO
{
    ...
    protected EList unmergedChanges;
    ...
    protected ResolveAsMergedResultDTOImpl() {
        this.ALL_FLAGS = 0;
    }
    
    protected EClass eStaticClass() {
        return FilesystemRestClientDTOconflictPackage.Literals.RESOLVE_AS_MERGED_RESULT_DTO;
    }
    ...
    public List getUnmergedChanges() {
        if (this.unmergedChanges == null) {
            this.unmergedChanges = (EList)new EObjectContainmentEList.Unsettable((Class)ConflictedChangeDTO.class, (InternalEObject)this, 3);
        }
        return (List)this.unmergedChanges;
    }
    
    public void unsetUnmergedChanges() {
        if (this.unmergedChanges != null) {
            ((InternalEList.Unsettable)this.unmergedChanges).unset();
        }
    }
    
    public boolean isSetUnmergedChanges() {
        return this.unmergedChanges != null && ((InternalEList.Unsettable)this.unmergedChanges).isSet();
    }
    ...
    public NotificationChain basicSetCommitDilemma(final CommitDilemmaDTO newCommitDilemma, NotificationChain msgs) {
        ...
        this.ALL_FLAGS |= 0x8;
        if (this.eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl((InternalEObject)this, 1, 6, (Object)oldCommitDilemma, (Object)newCommitDilemma, !oldCommitDilemmaESet);
            if (msgs == null) {
                msgs = (NotificationChain)notification;
            }
            else {
    ...
    public void setCommitDilemma(final CommitDilemmaDTO newCommitDilemma) {
        if (newCommitDilemma != this.commitDilemma) {
            NotificationChain msgs = null;
            if (this.commitDilemma != null) {
                msgs = ((InternalEObject)this.commitDilemma).eInverseRemove((InternalEObject)this, -7, (Class)null, msgs);
            }
            if (newCommitDilemma != null) {
                msgs = ((InternalEObject)newCommitDilemma).eInverseAdd((InternalEObject)this, -7, (Class)null, msgs);
            }
            ...
            this.ALL_FLAGS |= 0x8;
            if (this.eNotificationRequired()) {
                this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 1, 6, (Object)newCommitDilemma, (Object)newCommitDilemma, !oldCommitDilemmaESet));
            }
        }
    }
    ...
    public NotificationChain basicUnsetCommitDilemma(NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl((InternalEObject)this, 2, 6, (Object)oldCommitDilemma, (Object)null, oldCommitDilemmaESet);
            if (msgs == null) {
                msgs = (NotificationChain)notification;
            }
            else {
    ...
    public void unsetCommitDilemma() {
        if (this.commitDilemma != null) {
            ...
            this.ALL_FLAGS &= 0xFFFFFFF7;
            if (this.eNotificationRequired()) {
                this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 2, 6, (Object)null, (Object)null, oldCommitDilemmaESet));
            }
        }
    }
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID, final NotificationChain msgs) {
        switch (featureID) {
            ...
            case 3: {
                return ((InternalEList)this.getUnmergedChanges()).basicRemove((Object)otherEnd, msgs);
            }
            case 4: {
    ...
    public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
        switch (featureID) {
            ...
            case 3: {
                return this.getUnmergedChanges();
            }
            case 4: {
    ...
    public void eSet(final int featureID, final Object newValue) {
        switch (featureID) {
            ...
            case 3: {
                this.getUnmergedChanges().clear();
                this.getUnmergedChanges().addAll((Collection)newValue);
            }
            case 4: {
    ...
    public boolean eIsSet(final int featureID) {
        switch (featureID) {
            ...
            case 3: {
                return this.isSetUnmergedChanges();
            }
            case 4: {
