...
public class AbortCurrentPatchResultDTOImpl extends EObjectImpl implements AbortCurrentPatchResultDTO
{
    ...
    protected AbortCurrentPatchResultDTOImpl() {
        this.ALL_FLAGS = 0;
    }
    
    protected EClass eStaticClass() {
        return FilesystemRestClientDTOpatchPackage.Literals.ABORT_CURRENT_PATCH_RESULT_DTO;
    }
