...
public class ConfigurationDescriptorDTOImpl extends EObjectImpl implements ConfigurationDescriptorDTO
{
    ...
    protected ConfigurationDescriptorDTOImpl() {
        this.ALL_FLAGS = 0;
        this.componentItemId = ConfigurationDescriptorDTOImpl.COMPONENT_ITEM_ID_EDEFAULT;
    }
    ...
    public void unsetComponentItemId() {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 2, 0, (Object)oldComponentItemId, (Object)ConfigurationDescriptorDTOImpl.COMPONENT_ITEM_ID_EDEFAULT, oldComponentItemIdESet));
        }
    }
