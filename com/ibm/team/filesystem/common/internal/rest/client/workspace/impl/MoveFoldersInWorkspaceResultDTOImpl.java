...
public class MoveFoldersInWorkspaceResultDTOImpl extends EObjectImpl implements MoveFoldersInWorkspaceResultDTO
{
    ...
    protected MoveFoldersInWorkspaceResultDTOImpl() {
        this.ALL_FLAGS = 0;
    }
    
    protected EClass eStaticClass() {
        return FilesystemRestClientDTOworkspacePackage.Literals.MOVE_FOLDERS_IN_WORKSPACE_RESULT_DTO;
    }
