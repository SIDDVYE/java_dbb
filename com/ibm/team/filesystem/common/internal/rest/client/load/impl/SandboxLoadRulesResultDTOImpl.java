...
public class SandboxLoadRulesResultDTOImpl extends EObjectImpl implements SandboxLoadRulesResultDTO
{
    ...
    protected EList loadRules;
    protected EList loadRuleFiles;
    ...
    protected SandboxLoadRulesResultDTOImpl() {
        this.ALL_FLAGS = 0;
    }
    
    protected EClass eStaticClass() {
        return FilesystemRestClientDTOloadPackage.Literals.SANDBOX_LOAD_RULES_RESULT_DTO;
    }
    ...
    public List getLoadRules() {
        if (this.loadRules == null) {
            this.loadRules = (EList)new EObjectContainmentEList.Unsettable((Class)SandboxLoadRuleDTO.class, (InternalEObject)this, 1);
        }
        return (List)this.loadRules;
    }
    
    public void unsetLoadRules() {
        if (this.loadRules != null) {
            ((InternalEList.Unsettable)this.loadRules).unset();
        }
    }
    
    public boolean isSetLoadRules() {
        return this.loadRules != null && ((InternalEList.Unsettable)this.loadRules).isSet();
    }
    
    public List getLoadRuleFiles() {
        if (this.loadRuleFiles == null) {
            this.loadRuleFiles = (EList)new EObjectContainmentEList.Unsettable((Class)SandboxLoadRuleDTO.class, (InternalEObject)this, 2);
        }
        return (List)this.loadRuleFiles;
    }
    
    public void unsetLoadRuleFiles() {
        if (this.loadRuleFiles != null) {
            ((InternalEList.Unsettable)this.loadRuleFiles).unset();
        }
    }
    
    public boolean isSetLoadRuleFiles() {
        return this.loadRuleFiles != null && ((InternalEList.Unsettable)this.loadRuleFiles).isSet();
    }
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID, final NotificationChain msgs) {
        switch (featureID) {
            case 1: {
                return ((InternalEList)this.getLoadRules()).basicRemove((Object)otherEnd, msgs);
            }
            case 2: {
                return ((InternalEList)this.getLoadRuleFiles()).basicRemove((Object)otherEnd, msgs);
            }
            case 3: {
    ...
    public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
        switch (featureID) {
            ...
            case 1: {
                return this.getLoadRules();
            }
            case 2: {
                return this.getLoadRuleFiles();
            }
            case 3: {
    ...
    public void eSet(final int featureID, final Object newValue) {
        switch (featureID) {
            ...
            case 1: {
                this.getLoadRules().clear();
                this.getLoadRules().addAll((Collection)newValue);
            }
            case 2: {
                this.getLoadRuleFiles().clear();
                this.getLoadRuleFiles().addAll((Collection)newValue);
            }
            case 3: {
    ...
    public boolean eIsSet(final int featureID) {
        switch (featureID) {
            ...
            case 1: {
                return this.isSetLoadRules();
            }
            case 2: {
                return this.isSetLoadRuleFiles();
            }
            case 3: {
