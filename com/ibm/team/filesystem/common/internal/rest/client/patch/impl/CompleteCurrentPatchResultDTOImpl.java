...
public class CompleteCurrentPatchResultDTOImpl extends EObjectImpl implements CompleteCurrentPatchResultDTO
{
    ...
    protected EList unresolvedChanges;
    ...
    protected CompleteCurrentPatchResultDTOImpl() {
        this.ALL_FLAGS = 0;
        this.acceptQueueSize = 0L;
    }
    
    protected EClass eStaticClass() {
        return FilesystemRestClientDTOpatchPackage.Literals.COMPLETE_CURRENT_PATCH_RESULT_DTO;
    }
    ...
    public List getUnresolvedChanges() {
        if (this.unresolvedChanges == null) {
            this.unresolvedChanges = (EList)new EObjectResolvingEList.Unsettable((Class)VersionableChangeDTO.class, (InternalEObject)this, 6);
        }
        return (List)this.unresolvedChanges;
    }
    
    public void unsetUnresolvedChanges() {
        if (this.unresolvedChanges != null) {
            ((InternalEList.Unsettable)this.unresolvedChanges).unset();
        }
    }
    
    public boolean isSetUnresolvedChanges() {
        return this.unresolvedChanges != null && ((InternalEList.Unsettable)this.unresolvedChanges).isSet();
    }
    ...
    public void setAcceptQueueSize(final long newAcceptQueueSize) {
        ...
        final boolean oldAcceptQueueSizeESet = (this.ALL_FLAGS & 0x20) != 0x0;
        this.ALL_FLAGS |= 0x20;
        if (this.eNotificationRequired()) {
    ...
    public void eSet(final int featureID, final Object newValue) {
        switch (featureID) {
            ...
            case 6: {
                this.getUnresolvedChanges().clear();
                this.getUnresolvedChanges().addAll((Collection)newValue);
            }
            case 7: {
    ...
    public boolean eIsSet(final int featureID) {
        switch (featureID) {
            ...
            case 6: {
                return this.isSetUnresolvedChanges();
            }
            case 7: {
