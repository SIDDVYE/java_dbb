...
public class ConfigurationWithUncheckedInChanges2DTOImpl extends EObjectImpl implements ConfigurationWithUncheckedInChanges2DTO
{
    protected int ALL_FLAGS;
    protected static final int CHANGE_COUNT_EDEFAULT = 0;
    protected int changeCount;
    protected static final int CHANGE_COUNT_ESETFLAG = 1;
    protected ConfigurationDescriptor2DTO configuration;
    protected static final int CONFIGURATION_ESETFLAG = 2;
    
    protected ConfigurationWithUncheckedInChanges2DTOImpl() {
        this.ALL_FLAGS = 0;
        this.changeCount = 0;
    }
    
    protected EClass eStaticClass() {
        return FilesystemRestClientDTOcorePackage.Literals.CONFIGURATION_WITH_UNCHECKED_IN_CHANGES2_DTO;
    }
    ...
    public ConfigurationDescriptor2DTO getConfiguration() {
        if (this.configuration != null && ((EObject)this.configuration).eIsProxy()) {
            ...
            this.configuration = (ConfigurationDescriptor2DTO)this.eResolveProxy(oldConfiguration);
    ...
    public ConfigurationDescriptor2DTO basicGetConfiguration() {
        return this.configuration;
    }
    
    public void setConfiguration(final ConfigurationDescriptor2DTO newConfiguration) {
        final ConfigurationDescriptor2DTO oldConfiguration = this.configuration;
    ...
    public void eSet(final int featureID, final Object newValue) {
        switch (featureID) {
            ...
            case 1: {
                this.setConfiguration((ConfigurationDescriptor2DTO)newValue);
            }
            default: {
