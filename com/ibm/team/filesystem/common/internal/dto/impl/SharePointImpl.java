...
public class SharePointImpl extends EObjectImpl implements SharePoint
{
    ...
    protected static final int VERSIONABLE_ESETFLAG = 8;
    protected static final String COPY_FILE_AREA_EDEFAULT = "";
    protected String copyFileArea;
    protected static final int COPY_FILE_AREA_ESETFLAG = 16;
    protected EList relativePath;
    
    protected SharePointImpl() {
        this.ALL_FLAGS = 0;
        this.copyFileArea = "";
    }
    
    protected EClass eStaticClass() {
        return FilesystemDTOPackage.Literals.SHARE_POINT;
    }
    ...
    public IVersionableHandle getVersionable() {
        if (this.versionable != null && ((EObject)this.versionable).eIsProxy()) {
            final InternalEObject oldVersionable = (InternalEObject)this.versionable;
            this.versionable = (IVersionableHandle)this.eResolveProxy(oldVersionable);
            if (this.versionable != oldVersionable && this.eNotificationRequired()) {
                this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 9, 3, (Object)oldVersionable, (Object)this.versionable));
            }
        }
    ...
    public void setVersionable(final IVersionableHandle newVersionable) {
        final IVersionableHandle oldVersionable = this.versionable;
        this.versionable = newVersionable;
        final boolean oldVersionableESet = (this.ALL_FLAGS & 0x8) != 0x0;
        this.ALL_FLAGS |= 0x8;
        if (this.eNotificationRequired()) {
            this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 1, 3, (Object)oldVersionable, (Object)this.versionable, !oldVersionableESet));
        }
    }
    ...
    public void unsetVersionable() {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 2, 3, (Object)oldVersionable, (Object)null, oldVersionableESet));
        }
    }
    ...
    public String getCopyFileArea() {
        return this.copyFileArea;
    }
    
    public void setCopyFileArea(final String newCopyFileArea) {
        final String oldCopyFileArea = this.copyFileArea;
        this.copyFileArea = newCopyFileArea;
        final boolean oldCopyFileAreaESet = (this.ALL_FLAGS & 0x10) != 0x0;
        this.ALL_FLAGS |= 0x10;
        if (this.eNotificationRequired()) {
            this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 1, 4, (Object)oldCopyFileArea, (Object)this.copyFileArea, !oldCopyFileAreaESet));
        }
    }
    
    public void unsetCopyFileArea() {
        final String oldCopyFileArea = this.copyFileArea;
        final boolean oldCopyFileAreaESet = (this.ALL_FLAGS & 0x10) != 0x0;
        this.copyFileArea = "";
        this.ALL_FLAGS &= 0xFFFFFFEF;
        if (this.eNotificationRequired()) {
            this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 2, 4, (Object)oldCopyFileArea, (Object)"", oldCopyFileAreaESet));
        }
    }
    
    public boolean isSetCopyFileArea() {
        return (this.ALL_FLAGS & 0x10) != 0x0;
    }
    
    public List getRelativePath() {
        if (this.relativePath == null) {
            this.relativePath = (EList)new EDataTypeUniqueEList.Unsettable((Class)String.class, (InternalEObject)this, 5);
        }
        return (List)this.relativePath;
    }
    
    public void unsetRelativePath() {
        if (this.relativePath != null) {
            ((InternalEList.Unsettable)this.relativePath).unset();
        }
    }
    
    public boolean isSetRelativePath() {
        return this.relativePath != null && ((InternalEList.Unsettable)this.relativePath).isSet();
    }
    ...
    public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
        switch (featureID) {
            ...
            case 3: {
                if (resolve) {
                    return this.getVersionable();
                }
                return this.basicGetVersionable();
            }
            case 4: {
                return this.getCopyFileArea();
            }
            case 5: {
    ...
    public void eSet(final int featureID, final Object newValue) {
        switch (featureID) {
            ...
            case 3: {
                this.setVersionable((IVersionableHandle)newValue);
            }
            case 4: {
                this.setCopyFileArea((String)newValue);
            }
            case 5: {
                this.getRelativePath().clear();
                this.getRelativePath().addAll((Collection)newValue);
            }
            default: {
    ...
    public void eUnset(final int featureID) {
        switch (featureID) {
            ...
            case 3: {
                this.unsetVersionable();
            }
            case 4: {
                this.unsetCopyFileArea();
            }
            case 5: {
    ...
    public boolean eIsSet(final int featureID) {
        switch (featureID) {
            ...
            case 3: {
                return this.isSetVersionable();
            }
            case 4: {
                return this.isSetCopyFileArea();
            }
            case 5: {
    ...
    public String toString() {
        ...
        result.append(" (copyFileArea: ");
        if ((this.ALL_FLAGS & 0x10) != 0x0) {
            result.append(this.copyFileArea);
        }
        else {
            result.append("<unset>");
        }
        result.append(", relativePath: ");
        result.append(this.relativePath);
        result.append(')');
