...
public class OverlapResponseImpl extends EObjectImpl implements OverlapResponse
{
    ...
    protected EList overlapDescriptions;
    protected EList ancestorReports;
    
    protected OverlapResponseImpl() {
        this.ALL_FLAGS = 0;
    }
    
    protected EClass eStaticClass() {
        return FilesystemDTOPackage.Literals.OVERLAP_RESPONSE;
    }
    ...
    public IComponentHandle getComponent() {
        if (this.component != null && ((EObject)this.component).eIsProxy()) {
            ...
            if (this.component != oldComponent && this.eNotificationRequired()) {
                this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 9, 1, (Object)oldComponent, (Object)this.component));
            }
        }
    ...
    public void setComponent(final IComponentHandle newComponent) {
        ...
        this.ALL_FLAGS |= 0x2;
        if (this.eNotificationRequired()) {
            this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 1, 1, (Object)oldComponent, (Object)this.component, !oldComponentESet));
        }
    }
    ...
    public void unsetComponent() {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 2, 1, (Object)oldComponent, (Object)null, oldComponentESet));
        }
    }
    ...
    public IBaselineHandle getBaseline() {
        if (this.baseline != null && ((EObject)this.baseline).eIsProxy()) {
            ...
            if (this.baseline != oldBaseline && this.eNotificationRequired()) {
                this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 9, 2, (Object)oldBaseline, (Object)this.baseline));
            }
        }
    ...
    public void setBaseline(final IBaselineHandle newBaseline) {
        ...
        this.ALL_FLAGS |= 0x4;
        if (this.eNotificationRequired()) {
            this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 1, 2, (Object)oldBaseline, (Object)this.baseline, !oldBaselineESet));
        }
    }
    ...
    public void unsetBaseline() {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify((Notification)new ENotificationImpl((InternalEObject)this, 2, 2, (Object)oldBaseline, (Object)null, oldBaselineESet));
        }
    }
    ...
    public List getOverlapDescriptions() {
        if (this.overlapDescriptions == null) {
            this.overlapDescriptions = (EList)new EObjectContainmentEList.Unsettable(OverlapDescription.class, this, 3) {
                protected boolean isUnique() {
                    return false;
                }
            };
        }
        return (List)this.overlapDescriptions;
    }
    
    public void unsetOverlapDescriptions() {
        if (this.overlapDescriptions != null) {
            ((InternalEList.Unsettable)this.overlapDescriptions).unset();
        }
    }
    
    public boolean isSetOverlapDescriptions() {
        return this.overlapDescriptions != null && ((InternalEList.Unsettable)this.overlapDescriptions).isSet();
    }
    
    public List getAncestorReports() {
        if (this.ancestorReports == null) {
            this.ancestorReports = (EList)new EObjectResolvingEList.Unsettable((Class)IAncestorReport.class, (InternalEObject)this, 4);
        }
        return (List)this.ancestorReports;
    }
    
    public void unsetAncestorReports() {
        if (this.ancestorReports != null) {
            ((InternalEList.Unsettable)this.ancestorReports).unset();
        }
    }
    
    public boolean isSetAncestorReports() {
        return this.ancestorReports != null && ((InternalEList.Unsettable)this.ancestorReports).isSet();
    }
    
    public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID, final NotificationChain msgs) {
        switch (featureID) {
            case 3: {
                return ((InternalEList)this.getOverlapDescriptions()).basicRemove((Object)otherEnd, msgs);
            }
            default: {
    ...
    public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
        switch (featureID) {
            ...
            case 3: {
                return this.getOverlapDescriptions();
            }
            case 4: {
                return this.getAncestorReports();
            }
            default: {
    ...
    public void eSet(final int featureID, final Object newValue) {
        switch (featureID) {
            ...
            case 3: {
                this.getOverlapDescriptions().clear();
                this.getOverlapDescriptions().addAll((Collection)newValue);
            }
            case 4: {
                this.getAncestorReports().clear();
                this.getAncestorReports().addAll((Collection)newValue);
            }
            default: {
    ...
    public void eUnset(final int featureID) {
        switch (featureID) {
            ...
            case 3: {
                this.unsetOverlapDescriptions();
            }
            case 4: {
                this.unsetAncestorReports();
            }
            default: {
    ...
    public boolean eIsSet(final int featureID) {
        switch (featureID) {
            ...
            case 3: {
                return this.isSetOverlapDescriptions();
            }
            case 4: {
                return this.isSetAncestorReports();
            }
            default: {
