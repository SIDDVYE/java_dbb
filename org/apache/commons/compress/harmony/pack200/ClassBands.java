...
public class ClassBands extends BandSet
{
    ...
    public void finaliseBands() {
        ...
        final NewAttributeBands bands0;
        final NewAttributeBands bands2;
        final Comparator comparator = (arg0, arg1) -> {
            bands0 = arg0;
            bands2 = arg1;
            return bands0.getFlagIndex() - bands2.getFlagIndex();
        };
        ...
        for (final NewAttributeBands bands3 : this.classAttributeBands) {
            if (bands3.isUsedAtLeastOnce()) {
                final int[] backwardsCallCounts = bands3.numBackwardsCalls();
                for (int l = 0; l < backwardsCallCounts.length; ++l) {
                    classAttrCalls.add(backwardsCallCounts[l]);
                }
            }
        }
        for (final NewAttributeBands bands3 : this.methodAttributeBands) {
            if (bands3.isUsedAtLeastOnce()) {
                final int[] backwardsCallCounts = bands3.numBackwardsCalls();
                for (int l = 0; l < backwardsCallCounts.length; ++l) {
        ...
        for (final NewAttributeBands bands3 : this.fieldAttributeBands) {
            if (bands3.isUsedAtLeastOnce()) {
                final int[] backwardsCallCounts = bands3.numBackwardsCalls();
                for (int l = 0; l < backwardsCallCounts.length; ++l) {
        ...
        for (final NewAttributeBands bands3 : this.codeAttributeBands) {
            if (bands3.isUsedAtLeastOnce()) {
                final int[] backwardsCallCounts = bands3.numBackwardsCalls();
                for (int l = 0; l < backwardsCallCounts.length; ++l) {
